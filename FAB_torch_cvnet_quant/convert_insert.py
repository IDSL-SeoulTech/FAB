...
from cvnets.ptq import QAct, QConv2d
...
def assign_ptf(model):
    ...
    for name, module in model.named_modules():
        if isinstance(module, InvertedResidual):
            ...
            # conv1_1x1
            alpha = quant_loss(module.conv1_1x1_olc_qact.olc_quantizer.observer, module.block.exp_1x1.block.conv, lr=lr)
            module.conv1_1x1_olc.scale = alpha
            module.block.exp_1x1.block.conv.weight.data = module.block.exp_1x1.block.conv.weight.data * alpha
           
            # conv2_3x3
            # alpha = quant_loss(module.qact1_1x1.olc_quantizer.observer, module.block.conv_3x3.block.conv, lr=lr)
            # module.conv2_3x3_olc.scale = alpha
            # module.block.conv_3x3.block.conv.weight.data = module.block.conv_3x3.block.conv.weight.data * alpha
        


            # # conv3_1x1
            alpha = quant_loss(module.conv3_1x1_olc_qact.olc_quantizer.observer, module.block.red_1x1.block.conv, lr=lr)
            module.conv3_1x1_olc.scale = alpha
            module.block.red_1x1.block.conv.weight.data = module.block.red_1x1.block.conv.weight.data * alpha
